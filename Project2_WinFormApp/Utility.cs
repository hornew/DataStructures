...
namespace UtilityNamespace
{
	...
	public static class Utility
	{
		...
		private static string Clean (ref string work)
		{
			work = work.Trim (" \t".ToCharArray ( ));
			work = work.Replace ("\r\n", "\n");
			return work;
		...
		public static string WelcomeMessage ()
		{
            ...
            string Message = "Welcome and thank you for using this program.\nListed below is the"
                        + " current information about this product.";           
            Message += "\n\nAuthors:\tKristen Bales, Austin Horne, Jeremy Musick";
